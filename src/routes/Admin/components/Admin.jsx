...
class FacultiesPort extends React.Component {
  render(){
...
class DepartmentsPort extends React.Component {
  render(){
    if(this.props.active)
      return(
        <div className="col-md-3 col-sm-6 text-center active-port">
...
class CoursesPort extends React.Component {
  render(){
    if(this.props.active)
      return(
        <div className="col-md-3 col-sm-6 text-center active-port">
...
class ProgramsPort extends React.Component {
  render(){
    if(this.props.active)
      return(
        <div className="col-md-3 col-sm-6 text-center active-port">
